...
<ul class="sidebar-vertical">
    ...
    <li>
        <a href="admin-dashboard.php"><i class="la la-dashcube"></i> <span> Dashboard</span></a>
    </li>
    <li class="submenu">
        <a href="#"><i class="la la-user"></i> <span> Partners</span> <span class="menu-arrow"></span></a>
        <ul>
            <?php
            if (isAccountType($_SESSION['accountType'])) {
                echo '<li><a href="add-partner.php">Add Partners</a></li>';
            }
            ?>
            <li><a href="all-partners-list.php">All Partners List</a></li>
        </ul>
    </li>
    <li class="submenu">
        <a href="#"><i class="la la-users"></i> <span> Contents</span> <span class="menu-arrow"></span></a>
        <ul>
            <li><a href="add-content.php">Add Content</a></li>
            <li><a href="all-content-list.php">All Content List</a></li>
        </ul>
    </li>
    <li class="submenu">
        <a href="#"><i class="la la-users"></i> <span> Reports</span> <span class="menu-arrow"></span></a>
        <ul>
    ...
    <li class="submenu">
        <a href="#" class="noti-dot"><i class="la la-user-shield"></i> <span> Tenancy Agreement</span> <span class="menu-arrow"></span></a>
        <ul>
            <li><a href="tenancy-agreement.php">Send Agreements</a></li>
            <li><a href="tenancy-agreement-list.php">Tenancy Agreement List</a></li>
        </ul>
    </li>
    <li class="submenu">
        <a href="#" class="noti-dot"><i class="la la-user-shield"></i> <span> Leave</span> <span class="menu-arrow"></span></a>
        <ul>
            <li><a href="leave-request.php">Leave Request</a></li>
            <li><a href="leave-request-list.php">Leave Request List</a></li>
        </ul>
    </li>
    <li class="submenu">
        <a href="#" class="noti-dot"><i class="la la-user-shield"></i> <span> Tenants Guarantor Form</span> <span class="menu-arrow"></span></a>
        <ul>
            <li><a href="tenancy-guarantor-form.php">Send Guarantor Form</a></li>
            <li><a href="tenancy-guarantor-form-list.php">Tenancy Guarantor Form List</a></li>
        </ul>
    </li>
    <li>
        <a href="clients.html"><i class="la la-users"></i> <span>Clients</span></a>
    ...
    <li class="submenu">
        <a href="#"><i class="la la-receipt"></i> <span> Training Fees </span> <span class="menu-arrow"></span></a>
        <ul>
            <li><a href="training-fees.html">Client Info</a></li>
            <li><a href="payments-training-fees.html"> Payment Info </a></li>
        </ul>
    </li>
    <li class="menu-title">
        <span>Coaching</span>
    ...
    <li class="submenu">
        <a href="#"><i class="la la-file-alt"></i> <span> Coaching </span> <span class="menu-arrow"></span></a>
        <ul>
            <li><a href="coaching.html"> Coaching List </a></li>
            <li><a href="coaching-type.html"> Coaching Type </a></li>
        </ul>
    </li>-->
</ul>
