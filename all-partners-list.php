...
<?php
            if (isAccountType($_SESSION['accountType'])) {
                echo '<a href="add-partner.php" class="btn add-btn" data-bs-target="#add_employee"><i class="fa-solid fa-plus"></i> Add Partner</a>';
            }
?>
...
<table id="employeeTable" class="table table-striped custom-table datatable">
    ...
    <tbody>
        <?php if ($fetchallpartners->num_rows > 0): ?>
            <?php while($row = $fetchallpartners->fetch_assoc()): ?>
                <tr>
                    <td>
                    ...
                    <td class="text-end">
                        <div class="dropdown dropdown-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="edit-partner.php?id=<?php echo $row['partner_id']; ?>"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
                                <a class="dropdown-item" href="<?php echo $baseviewurl; ?>/<?php echo $row['partner_directory']; ?>" target="_blank"><i class="fa-regular fa-trash-can m-r-5"></i> View Page</a>
                            </div>
                        </div>
                    </td>
                </tr>
