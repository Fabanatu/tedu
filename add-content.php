...
<div class="row">
<div class="col-sm-12">
<h3 class="page-title">Add New Content</h3>
<ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="input-block mb-3">
                ...
                <input class="form-control" type="text" name="title" placeholder="Enter the title of the blog" required>
                <!--<input class="form-control" type="hidden" name="subcode" value="<?php echo $subcode; ?>">-->
            </div>
        </div>
        <div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Banner Image <span class="text-danger">*</span></label>
                <input class="form-control" type="file" name="bannerImage" accept="image/*" required>
            </div>
        </div>
        <div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Upload Video<span class="text-danger">*</span></label>
                <input type="file" class="form-control" name="content_video" accept="video/*" required>
            </div>
        </div>
        <!--<div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Content <span class="text-danger">*</span></label>
                <textarea class="form-control" id="contentEditor" name="content" rows="10" placeholder="Write the content here" required></textarea>
            </div>
        </div>-->
        <div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Content <span class="text-danger">*</span></label>
                <textarea class="form-control" id="body" name="content" required></textarea>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
        ...
        <div class="col-md-6">
            <div class="input-block mb-3">
                ...
                <input class="form-control" type="text" name="author" placeholder="Enter the author's name" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Keyword</label>
                <input class="form-control" type="text" name="keyword" placeholder="AUTO GENERATED" readonly>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Slug <span class="text-danger"></span></label>
                <input class="form-control" type="text" name="slug" placeholder="AUTO GENERATED" readonly>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                ...
                <?php if (!isAccountType($_SESSION['accountType'])): ?>
        ...
        <div class="col-md-12">
            <div class="input-block mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="categories[]" value="Music" id="music">
                    <label class="form-check-label" for="music">Music</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="categories[]" value="Entertainment" id="entertainment">
                    <label class="form-check-label" for="entertainment">Entertainment</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="categories[]" value="Technology" id="technology">
                    <label class="form-check-label" for="technology">Technology</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="categories[]" value="Health" id="health">
                    <label class="form-check-label" for="health">Health</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="categories[]" value="Sports" id="sports">
                    <label class="form-check-label" for="sports">Sports</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="categories[]" value="Education" id="education">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="categories[]" value="Lifestyle" id="lifestyle">
        ...
        <div class="col-md-12">
            <div class="input-block mb-3">
                ...
                <input class="form-control" type="text" name="tags" value="AUTO GENERATED" readonly>
                <small class="form-text text-muted">Separate tags with commas. Maximum of 5 tags.</small>
            </div>
        </div>
        <div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Active Date <span class="text-danger">*</span></label>
                <input class="form-control" type="date" name="activeDate" required>
            </div>
        </div>
        <div class="col-md-12">
    <div class="input-block mb-3">
        <label class="col-form-label">Summary</label>
        <textarea class="form-control" name="summary" rows="3" placeholder="Enter a brief summary of the content" maxlength="130" oninput="updateCharCount(this)"></textarea>
        <small id="charCount" class="form-text text-muted">0/130 characters</small>
    </div>
</div>
...
function updateCharCount(textarea) {
    ...
    document.getElementById('charCount').textContent = `${currentLength}/${maxChars} characters`;
}
</script>
    ...
    <div class="submit-section text-left"> <!-- Aligns the submit button to the left -->
        <button class="btn btn-primary submit-btn" type="submit" name="submitContent" style="border-radius: 0;">Submit</button> <!-- Rectangular button with name attribute -->
    </div>
</form>
...
<script>
    ...
    // JavaScript validation for content
...
<!-- Mirrored from smarthr.dreamstechnologies.com/html/template/admin-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Jul 2024 17:13:17 GMT -->
</html>