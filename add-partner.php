...
<div class="row">
<div class="col-sm-12">
<h3 class="page-title">Add New Partner</h3>
<ul class="breadcrumb">
...
<form class="partner-form" method="post" action="" enctype="multipart/form-data">
    <!-- Partner Information -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="input-block mb-3">
                ...
                <input class="form-control" type="text" name="social_media_links" placeholder="Comma-separated URLs">
            </div>
        </div>
        <div class="col-md-12">
    <div class="input-block mb-3">
        <label class="col-form-label">Bio <span class="text-danger">*</span></label>
        <textarea class="form-control" id="body" name="bio" rows="6" maxlength="300" required oninput="updateCharacterCount()"></textarea>
        <small id="charCount" class="form-text text-muted">0/300 characters</small>
    </div>
</div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Upload Intro Video<span class="text-danger">*</span></label>
                <input type="file" class="form-control" name="intro_video" accept="video/*" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Video Thumbnail<span class="text-danger">*</span></label>
        ...
        <div class="col-md-6">
    <div class="input-block mb-3">
        <label class="col-form-label">Subcode</label>
        <input class="form-control" type="text" name="subcode" placeholder="Operator Keyword" maxlength="6">
    </div>
</div>
<div class="col-md-6">
    <div class="input-block mb-3">
        <label class="col-form-label">Price</label>
        <input class="form-control" type="number" name="price" placeholder="Product Price" min="1" step="1">
    </div>
</div>
<div class="col-md-6">
    <div class="input-block mb-3">
    ...
    <div class="submit-section text-left">
        <button class="btn btn-primary submit-btn" type="submit" name="submit" style="border-radius: 0;">Submit</button>
    </div>
</form>
<script>
function updateCharacterCount() {
    ...
    charCount.textContent = `${textarea.value.length}/300 characters`;
}
</script>
...
<script>
        ...
        setup: function (editor) {
            ...
            editor.on('input', function () {
                ...
                if (charCount < minLength) {
                    bioHelp.classList.add('text-danger');
                    bioHelp.textContent = `You need to write at least ${minLength - charCount} more characters.`;
                    editor.getElement().setCustomValidity(`Please enter at least ${minLength} characters.`);
                } else {
                    bioHelp.classList.remove('text-danger');
                    bioHelp.textContent = '';
            ...
            editor.on('change', function () {
                tinymce.triggerSave(); // Ensures textarea is updated with the editor's content
            });
        }
    });
    ...
    document.querySelector('form').addEventListener('submit', function (e) {
        ...
        const content = tinymce.get('contentEditor').getContent({ format: 'text' }).trim();
        const minLength = 100;

        if (content.length < minLength) {
            alert(`Bio must be at least ${minLength} characters long.`);
            tinymce.activeEditor.focus(); // Focus TinyMCE editor if validation fails
