...
<form method="post" action=""> <!-- Add the method and action attributes -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="input-block mb-3">
                ...
                <input class="form-control" type="text" name="businessType" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
        ...
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Business Registration Number <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="registrationNumber" required>
            </div>
        </div>
        <div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Business Address <span class="text-danger">*</span></label>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Contact Person Email <span class="text-danger">*</span></label>
                <input class="form-control" type="email" name="contactPersonEmail" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Contact Person Phone Number <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="contactPersonPhoneNumber" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Contact Person Position <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="contactPersonPosition" required>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Annual Revenue <span class="text-danger">*</span></label>
                <input class="form-control" type="number" name="annualRevenue" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="input-block mb-3">
                <label class="col-form-label">Number of Employees <span class="text-danger">*</span></label>
                <input class="form-control" type="number" name="numberOfEmployees" required>
            </div>
        </div>
        <div class="col-md-12">
            <div class="input-block mb-3">
        ...
        <div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Business Description</label>
                <textarea class="form-control" name="businessDescription" rows="3"></textarea>
            </div>
        </div>
    </div>

    <div class="submit-section text-left"> <!-- Aligns the submit button to the left -->
        <button class="btn btn-primary submit-btn" type="submit" name="submitBusiness" style="border-radius: 0;">Submit</button> <!-- Rectangular button with name attribute -->
    </div>
</form>
