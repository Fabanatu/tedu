...
<div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
        <div class="card dash-widget">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    <h3><?php echo $totalActivePartners; ?></h3>
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
        <div class="card dash-widget">
            <div class="card-body">
                <span class="dash-widget-icon"><i class="fa-solid fa-user-slash"></i></span>
                <div class="dash-widget-info">
                    <h3><?php echo $totalInactivePartners; ?></h3>
...
<div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
        <div class="card dash-widget">
            <div class="card-body">
                <span class="dash-widget-icon"><i class="fa-solid fa-file-alt"></i></span>
                <div class="dash-widget-info">
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
        <div class="card dash-widget">
            <div class="card-body">
                <span class="dash-widget-icon"><i class="fa-solid fa-file-export"></i></span>
                <div class="dash-widget-info">
                    <h3><?php echo $totalPublishedContent; ?></h3>
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
        <div class="card dash-widget">
            <div class="card-body">
                <span class="dash-widget-icon"><i class="fa-solid fa-file-edit"></i></span>
                <div class="dash-widget-info">
                    <h3><?php echo $totalDraftContent; ?></h3>
...
<td><a href="https://smarthr.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b2d0d3c0c0cbd1c7d6d3f2d7cad3dfc2ded79cd1dddf">[email&#160;protected]</a></td>
<td>
