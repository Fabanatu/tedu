...
<ul class="breadcrumb">
<li class="breadcrumb-item active">Kindly Fill the leave form</li>
</ul>
</div>
</div>
</div>
...
<form>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Number of Days Entitled <span class="text-danger">*</span></label>
                <input class="form-control" type="number" required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Number of Days Requested For <span class="text-danger">*</span></label>
                <input class="form-control" type="number" required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Outstanding Leave Days</label>
                <input class="form-control" type="number">
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Date of First Day of Leave <span class="text-danger">*</span></label>
                <input class="form-control" type="date" required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Date of Last Day of Leave <span class="text-danger">*</span></label>
                <input class="form-control" type="date" required>
            </div>
        </div>
    </div>
    ...
    <!-- Details of Reliever -->
    <h4>Details of Reliever</h4>
    <hr>
    <div class="row">
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Hand Over Note Prepared <span class="text-danger">*</span></label>
                <select class="form-control" required>
                    <option value="">Select</option>
        ...
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Type of Reliever <span class="text-danger">*</span></label>
                <input class="form-control" type="text" required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Name of Reliever <span class="text-danger">*</span></label>
                <input class="form-control" type="text" required>
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Unit of Reliever <span class="text-danger">*</span></label>
                <input class="form-control" type="text" required>
            </div>
        </div>
    </div>
    ...
    <h4>Payment of Leave Allowance</h4>
    <hr>
    <div class="row">
        <div class="col-md-12">
            <div class="input-block mb-3">
                <label class="col-form-label">Leave Allowance</label>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="leaveAllowance" value="paid" required>
                    <label class="form-check-label">Paid</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="leaveAllowance" value="not_paid">
                    <label class="form-check-label">Not Paid</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="leaveAllowance" value="to_be_paid">
                    <label class="form-check-label">To Be Paid with This Request</label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Signature of Staff</label>
                <input class="form-control" type="text">
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Signature of Unit Supervisor</label>
                <input class="form-control" type="text">
            </div>
        </div>
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Authorized By</label>
                <input class="form-control" type="text">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="input-block mb-3">
                <label class="col-form-label">Staff Signature</label>
                <input class="form-control" type="text">
            </div>
        </div>
    </div>
    ...
    <div class="submit-section text-left">
        <button class="btn btn-primary submit-btn" style="border-radius: 0;">Submit</button>
    </div>
</form>
