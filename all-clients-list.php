...
<li class="breadcrumb-item active">All Content List</li>
</ul>
</div>
<div class="col-auto float-end ms-auto">
<a href="add-clients.php" class="btn add-btn"><i class="fa-solid fa-plus"></i> Add Client</a>
<div class="view-icons">
<a href="all-clients.php" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a>
<a href="all-clients-list.php" class="list-view btn btn-link"><i class="fa-solid fa-bars"></i></a>
</div>
</div>
</div>
</div>
                    ...
                    <td class="text-end">
                        <div class="dropdown dropdown-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="edit-business.php?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
